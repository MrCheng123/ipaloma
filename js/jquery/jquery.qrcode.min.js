...
for (function (a) {
    ...
    foreground: "#000000"
        ...
        c = function () {
            ...
            for (a.addData(utf16to8(b.text)), a.make(), c = document.createElement("canvas"), c.id = "canvasqrcode", c.width = b.width, c.height = b.height, d = c.getContext("2d"), b.src && (e = new Image(), e.src = b.src, e.onload = function () {

...
//*********************强势插入
//	var divOuterLong=document.createElement('div');
//	divOuterLong.className='divOuterLong';
//	this.content.appendChild(divOuterLong);
//	divOuterLong.innerHTML='';//右侧编辑，编辑结束后先点‘左’然后点击‘+按钮’返回
//*********************强势插入
    if (this.mode == 'code') {
...
/**
 * Detach the editor from the DOM从DOM分离编辑器
 * @private
 */
...
/**
 * Compact the code in the formatter紧凑的代码格式化程序
 */
...
/**
 * Format the code in the formatter格式格式化程序中的代码
 */
...
/**
 * Set json data in the formatter将json数据的格式化程序*******************
 * @param {Object} json
 */
...
/**
 * Get json data from the formatter从格式化程序获取json数据****************************
 * @return {Object} json
 */
...
/**
 * Get the text contents of the TextEditor得到TextEditor的文本内容
...
/**
 * Set the text contents of the TextEditor】设置TextEditor的文本内容
...
// register modes at the JSONEditor在JSONEditor注册模式

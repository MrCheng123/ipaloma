...
app.load = function() {
    try {
        ...
        //提升至主页
        // var json ={"vvvv":[1,2,3],"bbbb":true,"cccc":null,"dddd":123,"eeee":{"a":"b","c":"d","e":"f"},"fff":"HelloWorld"};
        // var json = {
        //     "array": [1, 2, 3],
        //     "boolean": true,
        //     "null": null,
		...
		var toSaveLongVar = document.getElementById("toSaveLong");
		toSaveLongVar.addEventListener('click',function(){
		    app.tosave();	    
		});

function Location() {
    this.items = {
        ...
        '0,2456': { 2457: '武汉市', 2471: '十堰市', 2485: '襄阳市', 2498: '荆门市', 2506: '孝感市', 2517: '黄冈市', 2535: '鄂州市', 2539: '黄石市', 2547: '咸宁市', 2558: '荆州市', 2570: '宜昌市', 2589: '随州市', 2592: '省直辖县级行政单位', 2598: '恩施州' },
...
function showLocation(province, city, town) {
    ...
    $('#loc_province').change(function () {
        ...
        $('#hiddenprovince').val(loc.find('0')[$('#loc_province').val()]);
    })
    $('#loc_city').change(function () {
        $('#loc_county').empty();
        $('#loc_county').append(title[2]);
        loc.fillOption('loc_county', '0,' + $('#loc_province').val() + ',' + $('#loc_city').val());
        $('#hiddencity').val(loc.find('0,' + $('#loc_province').val())[$('#loc_city').val()]);

        //$('input[@name=location_id]').val($(this).val());
    })
    $('#loc_county').change(function () {
        //$('input[@name=location_id]').val($(this).val());
        //
        $('#hiddencounty').val(loc.find('0,' + $('#loc_province').val() + ',' + $('#loc_city').val())[$('#loc_county').val()]);
    })
    if (province) {
        ...
        if (city) {
            ...
            if (town) {
                loc.fillOption('loc_county', '0,' + province + ',' + city, town);
